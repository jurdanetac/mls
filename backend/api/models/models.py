...
class PropertyListing(models.Model):
    class Status(models.TextChoices):
        ...
        ON_MARKET = "onMarket", "Active"
        OFF_MARKET = "offMarket", "Off Market"
        MEMBERS_ONLY_SHOW = "membersOnlyShow", "Members Only - Show"
        MEMBERS_ONLY_DO_NOT_SHOW = "membersOnlyDoNotShow", "Members Only - Do Not Show"
